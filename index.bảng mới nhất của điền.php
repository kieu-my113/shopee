  ...
  <div id="topSearchProducts" class="d-flex overflow-auto gap-3 pb-2">
    <?php
      ...
      while ($sp = mysqli_fetch_array($resultTop)) {
        echo "
        <a href='chiTietSanPham.php?masanpham=".$sp['masanpham']."' class='text-decoration-none text-light'>
          <div class='top-card'>
            ...
            <p class='mt-2 text-truncate'>".htmlspecialchars($sp['tensanpham'])."</p>
          </div>
        </a>
        ";
      }
      ...
      while ($sp = mysqli_fetch_array($resultGoiY)) {
        ...
        <div class='col'>
          <a href='chiTietSanPham.php?masanpham=".$sp['masanpham']."' class='text-decoration-none text-dark'>
              ...
              <img src='../images/".$sp['hinhanh']."' class='card-img-top' alt='".htmlspecialchars($sp['tensanpham'])."' style='height:200px; object-fit: cover; border-radius: 6px 6px 0 0;'>
              <div class='card-body p-2'>
                <p class='text-truncate fw-bold mb-1' style='font-size:14px;'>".htmlspecialchars($sp['tensanpham'])."</p>
                <p class='text-warning fw-bold mb-1'>".number_format($sp['giatien'])." đ</p>
